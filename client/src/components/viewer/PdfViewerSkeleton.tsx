  ...
  return (
    <div className="h-screen w-screen bg-slate-800 flex flex-col md:flex-row overflow-hidden animate-pulse">
      ...
      <div className="relative w-full md:w-3/5 h-full">
        {/* Header Skeleton */}
        <div className="absolute top-0 left-0 right-0 z-20 bg-neutral-950/80 h-12 flex items-center justify-between px-2 sm:px-4">
      ...
      {!isMobile && (
        <aside className="w-2/5 h-full bg-neutral-950 border-l border-slate-700 p-4">
